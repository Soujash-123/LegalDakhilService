  ...
  return (
    <ThemeProvider defaultTheme="light" storageKey="ui-theme">
      <div className="min-h-screen bg-white text-white">
        ...
        <div className="w-13 md:w-15 h-13 md:h-15 z-50 fixed right-5 bottom-25 p-4 bg-green-500 rounded-full text-white flex items-center justify-center cursor-pointer" onClick={openWhatsApp}>
        ...
        <div className="w-13 md:w-15 h-13 md:h-15 z-50 fixed right-5 bottom-7 p-4 bg-[#ba0cca] rounded-full text-white flex items-center justify-center cursor-pointer"
          onClick={() => setIsChatOpen(true)}
        >
          <MessageCircleMore />
        </div>
        {isVisible && (<div className="w-11 h-11 z-50 fixed right-22 bottom-7 md:bottom-8 p-2 bg-[#ba0cca] rounded-full text-white flex items-center justify-center cursor-pointer" onClick={() => scrollToSection(homeRef)}>
          <ChevronUp />
        </div>)}
        <AnimatePresence>
        {isChatOpen && (
