...
export default function FAQSection({ refs, scrollToSection }) {
  ...
  const faqs = {
    general: [
      {
        question: "What legal services does Daakhil Now offer?",
        answer:
          "Daakhil Now offers a comprehensive range of legal services including insurance claims, startup & company registration, trademark & intellectual property, GST services, income tax services, and legal consultancy for various matters.",
      },
      {
        question: "How can I get in touch with Daakhil Now Services?",
        answer:
